  ...
  <div class="card-body p-2">
   <ul class="nav nav-pills gap-2" id="laporanTab" role="tablist" style="flex-wrap:wrap;">
    <li class="nav-item" role="presentation">
     <button class="nav-link active" id="tab-kolam-btn" data-bs-toggle="tab" data-bs-target="#tab-kolam" type="button" role="tab" style="border-radius:10px;font-weight:600;">
    ...
    <li class="nav-item" role="presentation">
     <button class="nav-link" id="tab-pembudidaya-btn" data-bs-toggle="tab" data-bs-target="#tab-pembudidaya" type="button" role="tab" style="border-radius:10px;font-weight:600;">
 ...
 <div class="tab-content" id="laporanTabContent">
  ...
  <div class="tab-pane fade show active" id="tab-kolam" role="tabpanel">
   ...
   <div class="print-section-title" style="display:none;">
    <h4 style="font-weight:800;color:#1d4ed8;margin-bottom:12px;border-bottom:2px solid #1d4ed8;padding-bottom:8px;">
     Laporan Data Kolam
    </h4>
   </div>
     ...
     <div class="table-responsive">
      <table class="table table-hover mb-0" style="font-size:.88em;">
       ...
       <tbody>
        ...
        @empty
        <tr><td colspan="9" class="text-center py-5 text-muted">Belum ada data kolam.</td></tr>
        @endforelse
       </tbody>
      </table>
     </div>
  ...
  <div class="tab-pane fade" id="tab-jenis-ikan" role="tabpanel">
   ...
   {{-- Print title --}}
   <div class="print-section-title" style="display:none;">
    <h4 style="font-weight:800;color:#0891b2;margin-bottom:12px;border-bottom:2px solid #0891b2;padding-bottom:8px;">
     ...
     <div class="table-responsive">
      <table class="table table-hover mb-0" style="font-size:.88em;">
       ...
       <tbody>
        ...
        @empty
        <tr><td colspan="5" class="text-center py-5 text-muted">Belum ada data jenis ikan.</td></tr>
        @endforelse
       </tbody>
      </table>
     </div>
  ...
  <div class="tab-pane fade" id="tab-hasil-panen" role="tabpanel">
   ...
   {{-- Print title --}}
   <div class="print-section-title" style="display:none;">
    <h4 style="font-weight:800;color:#b45309;margin-bottom:12px;border-bottom:2px solid #b45309;padding-bottom:8px;">
  ...
  <div class="tab-pane fade" id="tab-pembudidaya" role="tabpanel">
   ...
   {{-- Print title --}}
   <div class="print-section-title" style="display:none;">
    <h4 style="font-weight:800;color:#14532d;margin-bottom:12px;border-bottom:2px solid #14532d;padding-bottom:8px;">
...
@media print {
 ...
 .pc-footer,
 #tab-pembudidaya,
 #tab-pembudidaya.show { display: none !important; }
 ...
 /* Table font kecil */
 table { font-size: .78em !important; }
